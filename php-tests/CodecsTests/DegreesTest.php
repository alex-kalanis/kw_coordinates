...
class DegreesTest extends CommonTestClass
{
    ...
    public function transferFromProvider(): array
    {
        return [
            ...
            [12.8069888666667, -49.4522626972222, 512.30, '12°48\'25.15992"E', '49°27\'8.14571"S', 512.30, true], // testovaci bod 109
    ...
    public function transferToProvider(): array
    {
        return [
            ...
            [-7.1930111333333, -49.4522626972222, 512.30, '352°48\'25.15992"E', '49°27\'8.14571"S', 512.30, true], // testovaci bod 109
